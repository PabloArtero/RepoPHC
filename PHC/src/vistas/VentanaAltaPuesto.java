 ...
 * @author mailt
 */
public class VentanaAltaPuesto extends javax.swing.JFrame {

    /**
     * Creates new form VentanaAltaPuesto
     */
    public VentanaAltaPuesto() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAltaPuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAltaPuesto().setVisible(true);
            }
        });
    }
