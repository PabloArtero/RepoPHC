 ...
 * @author mailt
 */
public class VentanaModificaTarea extends javax.swing.JFrame {

    /**
     * Creates new form VentanaAltaTarea
     */
    public VentanaModificaTarea() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaModificaTarea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaModificaTarea().setVisible(true);
            }
        });
    }
